...
- [x] **1d. Update `tests/test_antiquarian_settings_migration.py`:** in `test_voyageur_schema_matches_expected_shape`, remove `"LAC_MAX_WORKERS": "1",` from the `"LAC"` section and change `"HBCA_MAX_WORKERS": "10"` → `"8"` in the `"HBCA / Manitoba Archives"` section. These are intentional, schema-aligned changes (not "make the test pass" hacks).
- [x] **1e. Verify:** `python -m py_compile Voyageur/HBCA.py`; `python -m pytest tests/test_antiquarian_settings_migration.py tests/test_settings_schema_completeness.py tests/test_load_tool_schema.py -v`; `python -m pytest Voyageur/tests -v`; `python -m pycodestyle --max-line-length=120 Voyageur/HBCA.py`.
...
- [x] **4a. Normalize the 13 affected plan docs under `docs/superpowers/plans/`:** for each file containing `-x[` (confirmed: `2026-08-06-census-commissioner-wiring.md`, `2026-08-06-paleographer-structural-split.md`, `2026-08-06-paleographer-voyageur-debt-cleanup.md`, `2026-08-06-program-documentation.md`, `2026-08-06-scaffold-contract-extensibility.md`, `2026-08-06-voyageur-dispatcher-consolidation.md`, `2026-08-06-voyageur-parish-scrip-scaffold.md`, `2026-08-07-archivist-structural-split.md`, `2026-08-07-close-out-open-issues.md`, `2026-08-07-antiquarian-settings-redesign.md`, `2026-08-08-archivist-source-id-resolution.md`, `2026-08-08-familysearch-household-view-gather.md`, `2026-08-09-antiquarian-ui-overhaul.md`):
